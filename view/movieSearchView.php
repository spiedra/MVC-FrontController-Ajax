                ...
                <article class="registration-section__form-article">
                    <form class="registration-form" method="get" action="index.php">
                        ...
                        <div class="container-registration__form">
                            <input class="form__input-button--registration" type="submit" value="Search by name"
                                   name="buttonSearchByName">
                        </div>
                        <div class="container-registration__form">
                        ...
                        <div class="container-registration__form">
                            <input class="form__input-button--registration" type="submit" value="Search by genre"
                                   name="buttonSearchByGenre">
                        </div>
                        <div class="container-registration__form">
